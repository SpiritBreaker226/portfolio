...
export const About: FC = () => (
  <Container>
    ...
    <AboutContainer>
      <h2>About Me</h2>
      <p>
        Hi, my name is Jason. I am a web developer who loves solving challenging
        puzzles. The reason I got into programming is interesting. Growing up,
        my dad bought a Packard Bell 486 computer, and I was hooked immediately.
        I used to break Windows 3.1 to see how it worked. I could reinstall the
        OS in 5 minutes, so my family never found out what I was up to.
      </p>
      <p>
        ...
        company needing a creative, hard-working, and collaborative engineer. I
        feel I would be an excellent fit for your organization while supporting
        your needs in full-stack development, quality assurance, and tool
        enhancement.
      </p>
      <p>
        ...
        testing, supporting developers, and elevating the customer interface of
        an online catalogue.
      </p>
      <p>
